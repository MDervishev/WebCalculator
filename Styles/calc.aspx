...
<div class="centro">
        <asp:TextBox ID="TextBox1" runat="server" CssClass="text" Type="number" ></asp:TextBox><br />
        <div>
    ...
    <asp:Image ID="Image1" runat="server" ImageUrl="C:\Users\work\OneDrive\Music\Music\arduino_logo.png" />
    </div>
</asp:Content>
